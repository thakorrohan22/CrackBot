"""Update UserBot code (for CrackBot)
Syntax: .update
\nAll Credits goes to © @CRACKEXY
...
OFFICIAL_UPSTREAM_REPO = "https://github.com/Crackexy/CrackBot/tree/DEAD" 
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit("Updating and Deploying To New Branch. 5 minute Ruk and then use `.alive` to check if i'm working or not.")
